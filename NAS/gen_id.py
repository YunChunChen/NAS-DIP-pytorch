...
def gen_layer(C_in, C_out, model_index):
    ...
    if prim_op == 'pixel_shuffle' and conv_op == 'identity':
        return
    if act_op in ['none', 'ReLU']:
        return
    if kernel_size in ['1x1', '3x3', '7x7']:
        return
    else:
        print('{},'.format(selected_index), end="")

    #print(prim_op, conv_op, kernel_size, act_op)
    return
